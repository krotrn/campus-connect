              ...
              {!isLast && (
                <div
                  className={cn(
                    ...
                    isCompleted ? "bg-blue-600" : "bg-border/60"
                  )}
                />
              )}
            </div>
      ...
      <div className="md:hidden">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isActive && "bg-orange-500 shadow shadow-orange-500/30",
        ...
        <div className="flex items-center gap-2.5 px-1">
          {(() => {
            ...
            return (
              <>
                <div className="flex items-center justify-center h-7 w-7 rounded-lg bg-orange-500/10 text-orange-500">
